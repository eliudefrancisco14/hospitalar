...
<div class="col-md-6">
    <div class="form-group">
        ...
        <input type="text" name="description" id="description" value="{{ isset($slideshow->description) ? $slideshow->description : '' }}"
            class="form-control border-secondary" placeholder="Descrição">
    </div>
</div> <!-- /.col -->
