...
@section('title', 'Listar apresentação em slide')
            ...
            <div class="layout-page">
                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <form action="{{ route('admin.slide.slideSearch') }}" method="GET">
                                    @csrf
                ...
                <div class="container justify-content-center mt-2 mb-5">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <h5 class="card-header"> Silde Show: {{ $count }}</h5>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ url("admin/slide/show/{$datas->id}") }}"><i
                                                                    class="bx bx-detail"></i> Detalhe</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url("admin/slide/edit/{$datas->id}") }}"><i
                                                                    class="bx bx-edit-alt me-1"></i> Editar</a>
                                                            <a class="dropdown-item"
                                                                href="{{ url("admin/slide/delete/{$datas->id}") }}"><i
