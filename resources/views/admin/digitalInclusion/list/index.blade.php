                    ...
                    <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
                        ...
                        <div class="navbar-nav align-items-center">
                            <div class="nav-item d-flex align-items-center">
                                ...
                                <form action="{{ route('admin.digitalInclusion.digitalInclusionSearch') }}" method="GET">
                                    @csrf
                ...
                <div class="container justify-content-center mt-2 mb-5">
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <ul class="nav nav-pills flex-column flex-md-row mb-3">
                            <li class="nav-item">
                                <a class="nav-link active" href="{{ route('admin.digitalInclusion.create') }}"><i
                                        class="bx bx-user me-1"></i> Criar inclusão digital</a>
                            </li>
                        </ul>

                        <!-- Bootstrap Table with Header - Dark -->
                        <div class="card">
                            <h5 class="card-header"> Galeria de inclusão digital: {{ $count }}</h5>
