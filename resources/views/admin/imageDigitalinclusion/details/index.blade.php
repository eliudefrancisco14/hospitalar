            ...
            <div class="layout-page">
                ...
                <div class="container justify-content-center mt-2 mb-5">
                    <ul class="nav nav-pills flex-column flex-md-row mb-3">
                        <li class="nav-item">
                            <a class="nav-link active" href="{{ route('admin.digitalInclusion.create') }}"><i class="bx bx-user me-1"></i> Criar inclusão digital</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    ...
                                    <img src="{{ asset('storage') }}/digitalInclusion_image/{{ $data['image'] }}" alt="user-avatar" class="d-block rounded"
