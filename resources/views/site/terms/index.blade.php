                        ...
                        <div style="text-align:justify;" class="col-md-12 text-justify my-5">
                            ...
                            <div class="row">
                                <p class="mt-3">
                                    ...
                                    Condições de
                                    Utilização,
                                    destina-se a regular o processo de tratamento de dados pessoais a realizar pelo INFOSI
                                    por
                                    conta da
                                    utilização
                                    deste website. <br>
                                ...
                                <ul class="mt-3">
                                    ...
                                    <li>Fornecer informação sobre produtos, serviços, atividades de marketing,
                                        campanhas,
                                        promoções, fins estatísticos e conteúdos personalizados, mediante o consentimento
                                        prévio
                                        para o
                                        efeito.</li>
                                </ul>
                                ...
                                <br><br>
                                O INFOSI não efetuará o tratamento de dados pessoais que revelem a origem racial ou étnica,
                                as
                                opiniões
                                ...
                                <p class="mt-3">
                                    ...
                                    O INFOSI dará o seu consentimento prévio relativamente à recepção de comunicações
                                    comerciais
                                    para fins
                                    de
                                    ...
                                    <br>
                                    As referidas informações comerciais, poderão ser enviadas pelo INFOSI, através de
                                    correio
                                    eletrónico,
                                    telefone, SMS
                                ...
                                <p class="mt-3">
                                    ...
                                    com
                                    entidades terceiras sem o seu concentimento.
                                </p>
                                <p class="mt-3">
                                ...
                                <p class="mt-3">
                                    <b>Cookies</b><br>
                                    O INFOSI poderá utilizar cookies no seu website com o objectivo de melhorar a qualidade
                                    do
