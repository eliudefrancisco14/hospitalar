          ...
          <form action="{{ route('site.pacient.store') }}" method="post" role="form" class="php-email-form p-5 rounded shadow">
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group mt-3 mt-md-0">
                ...
                <input type="text" class="form-control" id="nBI" name="nBI" value="{{ old('nBI') }}" required>
              </div>

              <div class="col-md-4 form-group">
                <label for="morada">Morada:</label>
                <input type="text" class="form-control" id="morada" name="morada" value="{{ old('morada') }}" required>
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 form-group">
                ...
                <input type="text" class="form-control" id="peso" value="{{ old('peso') }}" name="peso">
              </div>

              <div class="col-md-4 form-group mt-3 mt-md-0">
                <label for="altura">Altura:</label>
                <input type="text" class="form-control" id="altura" value="{{ old('altura') }}" name="altura">
              </div>
            ...
            <div class="row">
              <div class="col-md-6 form-group">
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="gripe" name="sintomas[]" value="Gripe">
                  <label class="form-check-label" for="gripe">Gripe</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Nauseas" name="sintomas[]" value="Náuseas">
                  <label class="form-check-label" for="Nauseas">Náuseas</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Fadigas" name="sintomas[]" value="Fadigas">
                  <label class="form-check-label" for="Fadigas">Fadigas</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Vomitos" name="sintomas[]" value="Vomitos">
                  <label class="form-check-label" for="Vomitos">Vomitos</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Desmaios" name="sintomas[]" value="Desmaios">
                  <label class="form-check-label" for="Desmaios">Desmaios/Tonturas</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Fraquezas" name="sintomas[]" value="Fraquezas">
                  <label class="form-check-label" for="Fraquezas">Fraquezas</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="FebreAlta" name="sintomas[]" value="Febre Alta">
                  <label class="form-check-label" for="FebreAlta">Febre Alta</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="peito" name="sintomas[]" value="Dor no peito">
                  <label class="form-check-label" for="peito">Dor no peito</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Falta" name="sintomas[]" value="Falta de ar">
                  <label class="form-check-label" for="Falta">Falta de ar</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Cabeca" name="sintomas[]" value="Dor de Cabeça">
                  <label class="form-check-label" for="Cabeca">Dor de Cabeça</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Calafrios" name="sintomas[]" value="Calafrios">
                  <label class="form-check-label" for="Calafrios">Calafrios</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="UrinaEscura" name="sintomas[]" value="Urina escura">
                  <label class="form-check-label" for="UrinaEscura">Urina escura</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="FebreBaixa" name="sintomas[]" value="Febre baixa">
                  <label class="form-check-label" for="FebreBaixa">Febre baixa</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Hemorragias" name="sintomas[]" value="Hemorragias">
              ...
              <div class="col-md-6 form-group">
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Diarreia" name="historico[]" value="Diarreia">
                  <label class="form-check-label" for="Diarreia">Diarreia</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Colera" name="historico[]" value="Cólera">
                  <label class="form-check-label" for="Colera">Cólera</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="HIV" name="historico[]" value="HIV">
                  <label class="form-check-label" for="HIV">HIV</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="FebreAmarela" name="historico[]" value="Febre Amarela">
                  <label class="form-check-label" for="FebreAmarela">Febre Amarela</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="FebreTefoide" name="historico[]" value="Febre Tefóide">
                  <label class="form-check-label" for="FebreTefoide">Febre Tefóide</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Pneumonia" name="historico[]" value="Pneumonia">
              ...
              <div class="col-md-6 form-group">
                ...
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="fezesClaras" name="condicoesMedicas[]" value="Fezes Claras">
                  <label class="form-check-label" for="fezesClaras">Fezes Claras</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="PercadePesoinexplicável" name="condicoesMedicas[]" value="Perca de Peso inexplicável">
                  <label class="form-check-label" for="PercadePesoinexplicável">Perca de Peso inexplicável</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Amarelamentodapeleeolhos" name="condicoesMedicas[]" value="Amarelamento da pele e olhos">
                  <label class="form-check-label" for="Amarelamentodapeleeolhos">Amarelamento da pele e olhos</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="SuoresNocturnos" name="condicoesMedicas[]" value="Suores Nocturnos">
                  <label class="form-check-label" for="SuoresNocturnos">Suores Nocturnos</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Colicasabdominais" name="condicoesMedicas[]" value="Cólicas abdominais">
                  <label class="form-check-label" for="Colicasabdominais">Cólicas abdominais</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Tossecomsangue" name="condicoesMedicas[]" value="Tosse com sangue">
                  <label class="form-check-label" for="Tossecomsangue">Tosse com sangue</label>
                </div>
                <div class="form-check">
                  <input type="checkbox" class="form-check-input" id="Inchaconospesoupernas" name="condicoesMedicas[]" value="Inchaço nos pés ou pernas">
                  <label class="form-check-label" for="Inchaconospesoupernas">Inchaço nos pés ou pernas</label>
                </div>
                <div class="form-check">
