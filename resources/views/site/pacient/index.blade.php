...
@section('content')
                        ...
                        <form action="{{ route('site.pacient.store') }}" method="post" role="form"
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group mb-2 mt-3 mt-md-0">
                                    <label for="nomeCompleto"> <b> Nome Completo: <span
                                                style="color: red">*</span></b></label>
                                    <input type="text" class="form-control" id="nomeCompleto" name="nomeCompleto"
                                        placeholder="Informe o seu Nome" value="{{ old('nomeCompleto') }}" required>
                                </div>
                                ...
                                <div class="col-md-6 form-group mb-2">
                                    ...
                                    <input type="text" class="form-control" id="morada" name="morada"
                                        placeholder="Informe a sua Morada" value="{{ old('morada') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="medicacao"> <b> Está sob alguma medicação?<span
                                                style="color: red">*</span></b></label>
                                ...
                                <div class="col-md-6 form-group">
                                    <label for="gravidade"> <b> Gravidade dos Sintomas:<span
                                                style="color: red">*</span></b></label>
                            ...
                            <div class="form-group mt-3">
                                <label for="doencasCronicas"> <b> Doenças Crônicas:<span
                                            style="color: red">*</span></b></label>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <textarea class="form-control" id="maisInformacoes" name="maisInformacoes" placeholder="Informe mais detalhes"
                                    rows="8">{{ old('maisInformacoes') }}</textarea>
                            </div>
    ...
    {{-- <script>
        $('#temperatura').on('click', function() {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#temperatura').empty();
                    if (data) {
                        $('#temperatura').attr('value', data.temperatura);
                    } else {
                        $('#temperatura').empty();
                    }
                }
        ...
        $('#batimento').on('click', function() {
            $.ajax({
                url: 'api/v1/get/batimento/' /* + nProcess*/ ,
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    console.log(data);
                    $('#batimento').empty();
                    if (data) {
                        $('#batimento').attr('value', data.batimento);
                    } else {
                        $('#batimento').empty();
                    }
                }
